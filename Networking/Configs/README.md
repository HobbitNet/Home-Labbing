...
* Policy as code (Iac): The [Tailscale Policy JSON](tailscalepolicy.json) being in this repository has allowed me to establish a "single source of truth" which means any future manual changes in the Tailscale console can be audited against this current file to ensure they align with my original security stance
